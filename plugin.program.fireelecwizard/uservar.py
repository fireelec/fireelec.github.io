...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR limegreen][B]fireelec[/B][/COLOR]fireelec Wizard'
BUILDERNAME = 'fireelec'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://www.dropbox.com/s/3dceegfeh498xja/builds.txt?dl=1'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]fireelec[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
REPOZIPURL = 'https://raw.githubusercontent.com/a4k-openproject/repository.openwizard/master/zips/repository.openwizard/'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]fireelec[/B][/COLOR]Wizard'
